...
{
    internal sealed class ItemContextDebugCommand
    {
        /// <summary>
        /// Command ID.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ItemContextDebugCommand"/> class.
        ...
        /// </summary>
        public static ItemContextDebugCommand Instance
        {
            get;
            private set;
        }
        ...
        {
            Instance = new ItemContextDebugCommand(package);
        }
